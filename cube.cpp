...
// Define the completely solved state of the cube
...
// Hardcoded cube state for testing
  // CubeState  initialCube = {
  // {"B", "R", "W"}, {"G", "O", "W"},
  // {"O", "G", "Y"}, {"Y", "B", "O"},
  // {"G", "R", "Y"}, {"B", "Y", "R"},
  // {"G", "W", "R"}, {"O", "B", "W"}
  // };
//   Either use the above method for the initial cube state or use the following sequence of moves to make the inital cube state of the cube.
    // The following sequence of moves to make the inital cube state of the cube.
